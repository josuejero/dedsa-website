    ...
    <div className="bg-white p-8 rounded-lg shadow-md mb-12">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p>
            Democratic socialism is a political philosophy that advocates for economic and social
            democracy alongside political democracy. We believe that both the economy and society
